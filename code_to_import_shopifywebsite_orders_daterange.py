...
# Your UNIQUE KEY:
#
# ordernumber + lineitemkey + sku
#
# means MySQL automatically skips existing records.
...
try:
    ...
    for start in range(
        ...
        try:
            ...
            # ------------------------------------------------
            # Roll back ONLY the current batch
            #
            # No commit yet.
            # ------------------------------------------------
            ...
            # ------------------------------------------------
            # PROCESS BAD BATCH INDIVIDUALLY
            # ------------------------------------------------
            ...
            for row in batch:
                ...
                try:
                    ...
                    # ----------------------------------------
                    # Try again with optional fields empty
                    # ----------------------------------------
